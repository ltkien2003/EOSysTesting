 ...
 * @author Admin
 */
public class ThamGiaKHJDialog extends javax.swing.JDialog {
    ...
    public ThamGiaKHJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    }

    public ThamGiaKHJDialog() {
    ...
    HocVien getForm() {
        ...
        hv.setMaKH(Integer.parseInt(txtMaKH.getText()));
        hv.setMaND(Auth.user1.getMaND());
        return hv;
    }
    ...
    void fillTable() {
        ...
        model.setRowCount(0);
        try {
            List<KhoaHoc> list = khdao.selectByNotJoined(Auth.user1.getMaND());
            for (KhoaHoc kh : list) {
    ...
    private void initComponents() {
        ...
        setTitle("EOSys - Tham gia khóa học");
        ...
        btnThem.setText("Tham gia khóa học");
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        if (txtMaKH.getText().trim().equals("")) {
            ...
            fillTable();
            clearForm();
            MsgBox.alert(this, "Tham gia khóa học thành công");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThamGiaKHJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ThamGiaKHJDialog dialog = new ThamGiaKHJDialog(new javax.swing.JFrame(), true);
